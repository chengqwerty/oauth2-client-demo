...
public class AuthorizationCodeTokenResponseClient implements OAuth2AccessTokenResponseClient<OAuth2AuthorizationCodeGrantRequest> {
    ...
    public AuthorizationCodeTokenResponseClient() {
        RestTemplate restTemplate = new RestTemplate(Arrays.asList(
                new FormHttpMessageConverter(), getOAuth2AccessTokenResponseHttpMessageConverter()));
        restTemplate.setErrorHandler(new OAuth2ErrorResponseErrorHandler());
        this.restOperations = restTemplate;
    }

    public OAuth2AccessTokenResponseHttpMessageConverter getOAuth2AccessTokenResponseHttpMessageConverter() {
        ...
        oAuth2AccessTokenResponseHttpMessageConverter.setTokenResponseConverter(new AccessTokenResponseConverter());
        return oAuth2AccessTokenResponseHttpMessageConverter;
    }
